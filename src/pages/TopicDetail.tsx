...
import { BookOpen, Brain, Search, ArrowLeft, Clock, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: `${topic.lessons} bài học chi tiết về ${topic.title.toLowerCase()}`,
      icon: BookOpen,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            <div className="flex items-center">
              <div className={`w-16 h-16 ${topic.color} rounded-xl flex items-center justify-center mr-4`}>
